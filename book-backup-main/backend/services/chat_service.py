...
from schemas.chat import Message as MessageSchema, Citation

class ChatService:
    def create_conversation(self, db: Session, user_id: int, initial_question: str) -> Conversation:
    ...
    def get_conversation(self, db: Session, conversation_id: UUID) -> Optional[Conversation]:
